...
import { Heart, CheckCircle2, Clock, Trash2 } from 'lucide-react';
...
export function MontasView({ reproductions, onSuccess }: MontasViewProps) {
  const { showToast } = useToast();

  const { data: allMales = [], isLoading: loadingMales, refetch: fetchMales } = useQuery({
