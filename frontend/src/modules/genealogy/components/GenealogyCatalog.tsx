...
export function GenealogyCatalog({ onViewTree, onEditRelation, onDeleteRelation }: GenealogyCatalogProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {loading ? (
        <LoadingMessage message="Cargando genealogías..." />
      ) : rabbits.length === 0 ? (
              ...
              details={
                <>
                  <div className="flex items-center gap-1">
                    <span className="font-semibold text-slate-700">Edad:</span> {rabbit.age !== null && rabbit.age !== undefined ? `${rabbit.age} ${rabbit.age === 1 ? 'mes' : 'meses'}` : '-'}
                  </div>
