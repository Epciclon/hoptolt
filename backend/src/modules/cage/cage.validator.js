const validateCreateCage = (req, res, next) => {
    ...
    if (status && !['operativa', 'mantenimiento'].includes(status)) {
        errors.push('El estado debe ser operativa o mantenimiento.');
    }
...
module.exports = { validateCreateCage, validateEditCage };
